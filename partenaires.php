...
$mailto = 'info@proximis.com';
 ...
 $subject = "Inscription alerte Partenaires";
 $message = "Une personne souhaite être tenue au courant de la mise en ligne de la page partenaires sur change-commerce.com : " . $mail;
	...
	<body>
				...
				<div class="container">
					<nav class="bottom-header">
						...
						<ul id="menu-header">
							...
							<li class="active lien-temp"><a href="programme-integrateurs" title="Partenaires"><span>Partenaires</span></a></li>
		...
		<div class="content">
			<div class="container first small small-temp">
				...
				<p><b>Change accorde une place essentielle à la relation qu'elle entretient avec vous</b> (partenaires technologiques et partenaires d’intégration). Découvrez prochainement notre programme d'adhésion et d'animation qui vous sera exclusivement dédié.</p>
			</div>
